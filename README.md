...
This project uses a scoping review approach aligned with PRISMA-ScR to identify publicly available datasets on mosquito activity, environmental conditions, and ecological factors; characterize their variables, accessibility, geographic and temporal coverage, resolution, and limitations; and evaluate how they can be integrated for mosquito surveillance. As a pilot analysis, the project integrates mosquito trapping data from the National Ecological Observatory Network (NEON) at Harvard Forest with environmental measurements such as temperature, humidity, and precipitation. Time-series visualizations examine how mosquito abundance and environmental conditions change over time, while correlation analyses evaluate associations between mosquito abundance and current and lagged environmental variables. Together, the review and pilot analysis assess both the availability of relevant public data and their practical potential for integrated, data-driven mosquito surveillance.
...
- [AnimalHack 2026](https://animalhack2026.devpost.com/), September 2026
